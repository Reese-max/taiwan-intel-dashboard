...
export const DOMAIN_COVERAGE = [
  ...
  { key: "教育／科研", scope: "domestic", status: "gap", note: "尚未有符合本平台事件新鮮度契約的整合來源" },
  { key: "社福／人口", scope: "domestic", status: "gap", note: "尚未有全國一致且可持續抓取的事件層" },
  { key: "文化／觀光／體育", scope: "domestic", status: "gap", note: "可在開放資料查詢頁搜尋，尚未併入事件層" },
